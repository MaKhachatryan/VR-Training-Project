...
-Outliers:
--  In the 50+ age group (with only one participant aged 51), the subject showed very low perceived stress and recorded the highest RMSSD compared to the rest of the cohort.
--   A Subject in the NonAdaptive training version in Linne cohort with perceived stress > 3 and very low heart rate.
:::
