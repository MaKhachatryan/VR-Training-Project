...
hrvQ1ByAgeCombined
```
<span style="font-size:18px;">The plot shows that as cognitive load increases, RMSSD decreases, with high HRV defined as RMSSD values above the 0.9 quantile, indicating lower autonomic flexibility under stress.</span>
