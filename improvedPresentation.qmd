...
::: {style="padding-left:30px"}
-  Subgroups: 
</br> --  **Dame Males (Perceived Stress \> 4)**: High cognitive load with low heart rate. 
</br> --  **Linne Adaptive Males**: High cognitive load with low to moderate heart rate. 
</br> --  **Age 20-30**: High RMSSD at low stress levels in the combined cohort. </br>
:::
