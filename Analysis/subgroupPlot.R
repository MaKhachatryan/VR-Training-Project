...
hrQ1ScatterPlotFunction <- function(data, col_x, col_y, col_group, cohort, gender) {
  ...
  plot_title <- if (cohort == "Linne") {
    ifelse(
      is.null(gender),
      paste0("Relationship between Heart Rate and Cognitive Load by Training Version (",cohort,")", sep = ""),
      paste0("Relationship between Heart Rate and Cognitive Load by Training Version in ", gender_title, " (",cohort,")")
    )
  } else if (cohort == "Dame") {
    paste0("Relationship between Heart Rate and Cognitive Load by Gender in ", "(",cohort,")")
  } else {
    ifelse(
      is.null(gender),
      paste0("Relationship between Heart Rate and Cognitive Load by", col_group, "(",cohort,")", sep = " "),
      paste0("Relationship between Heart Rate and Cognitive Load by", col_group, "in ", gender_title, " (",cohort,")")
    )
  }
